...
public class JsonMapper {
    ...
    public static <T> String obj2String(T src) {
        ...
        try {
            ...
            log.error("parse object to String excepation error:{}", e);
            return null;
        }
    }
    ...
    public static <T> T String2Object(String src, TypeReference<T> tTypeReference) {
        ...
        try {
            ...
            log.error("parse String to object Excepation String:{} ,TypeReference<T>:{},error:{} ", src, tTypeReference.getType(), e);
            return null;
        }
